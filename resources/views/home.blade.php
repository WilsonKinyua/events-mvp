        ...
        <div role="tabpanel" class="tab-pane fade" id="tab14">
          <div class="row">
            ...
            <div class="add-company">
                @can('event_setting_access')
                {{-- <a class="m-3" title="Edit Sliders" data-toggle="modal" data-target="#slidersmodal"> <i class="fa fa-edit"></i> Add Company</a> --}}
                ...
                <button class="btn btn-info btn-sm mb-4"><i class="fa fa-copy"></i> Import Company</button>
                {{-- add company modal --}} 
