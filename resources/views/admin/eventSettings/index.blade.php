                        ...
                        <tr data-entry-id="{{ $eventSetting->id }}">
                            ...
                            <td>
                                @can('event_setting_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.event-settings.show', $eventSetting->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('event_setting_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.event-settings.edit', $eventSetting->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('event_setting_delete')
                                    <form action="{{ route('admin.event-settings.destroy', $eventSetting->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
